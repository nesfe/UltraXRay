...
Актуальная версия проверяет ровно тот hostname, который ввёл пользователь. Если сертификат или TLS-ответ не подходят для выбранного `REALITY SNI`, установка останавливается и печатает первые строки лога OpenSSL.
