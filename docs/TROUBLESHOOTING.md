...
Актуальная версия не останавливает установку на временной ошибке TLS-проверки. Она пробует исходный hostname, затем `www.` fallback, после чего продолжает установку с предупреждением.
