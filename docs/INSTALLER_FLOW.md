...
- TLS-проверка `lemanapro.ru` выполняется для ровно введённого SNI;
- если проверка не проходит, установка останавливается и печатает лог OpenSSL, как в ClearXRay.
